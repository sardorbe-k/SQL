--1 Easy-Level Tasks (7)
select o.OrderID, c.FirstName, o.OrderDate from Orders as o
join Customers as c on o.CustomerID=c.CustomerID and o.OrderDate>'2022-01-01'

--2
select e.Name, d.DepartmentName from Employees as e
join Departments as d on e.DepartmentID=d.DepartmentID and d.DepartmentName in ('marketing' , 'sales')
...
join Orders as o on c.CustomerID=o.CustomerID and c.Country ='usa' and o.OrderDate between '2023-01-01' and '2023-12-31'

--5
select c.FirstName, COUNT(o.OrderID) as totalorder from Orders as o
...
--8 Medium-Level Tasks (6)
select c.FirstName, o.TotalAmount from Orders as o
join Customers as c on o.CustomerID=c.CustomerID and o.TotalAmount>500 

--9
select p.ProductName, s.SaleDate, s.SaleAmount from Products as p
join Sales as s on p.ProductID=s.ProductID and s.SaleDate between '2022-01-01' and '2022-12-31' and s.SaleAmount >400

--10
select p.ProductName, sum(s.SaleAmount) as total_sale_amount from Sales as s
...
join Sales as s
on p.ProductID=s.ProductID and p.Category='Electronics' or s.SaleAmount>350

--16
select c.Categoryname, count(p.Category) as productcount  from products as p
...
select e.Name, d.DepartmentName from Employees as e
join Departments as d
on e.DepartmentID=d.DepartmentID and d.DepartmentName in ('HR','finance')  OR 
    (
        LEN(e.Name) 
