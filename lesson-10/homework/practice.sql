...
--6
select e1.Name, e2.Name as manager_name from Employees as e1
left join Employees as e2 on e1.ManagerID=e2.EmployeeID

--7
select s.Name, c.CourseName from Enrollments as e
...
--21
select p.ProductID, p.ProductName from Products as p 
left join Categories as c on p.Category=c.CategoryName
